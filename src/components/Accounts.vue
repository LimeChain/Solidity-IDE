<template>
    <div class="d-flex flex-column h-50 bg-dark bottom-separator">
        <div class="p-2 d-flex flex-horizontal justify-content-between align-items-center flex-shrink-0">
            ...
            <div>
                <button style="display:none" class="btn btn-primary btn-sm mr-1" @click="$refs.hostModal.show()" title="Change Ganache host"><i class="icon host"></i></button>
                <button style="display:none" class="btn btn-primary btn-sm" @click="updateAccounts()" title="Refresh"><i class="icon refresh"></i></button>
            </div>
        </div>
